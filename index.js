...
function (_Component) {
  ...
  function Emulator(props) {
    ...
    _this.markAllCheckString = function (markListData) {
    ...
    _this.clearAllMarkChackString = function (elStr) {
    ...
    _this.markStringChackString = function (markType, highlight) {
      var newMarkList = "";
    ...
    _this.clearMarkString = function (markType) {
      var newMarkList = "";
      var markList = _this.state.markList;
      var markData = {};
...
function (_Emulator) {
  ...
  function FieldsMapping() {
    ...
    _this.onMouseUp = function (callbackFn) {
      var id = _this.state.id;
    ...
    _this.onDoubleClick = function (callbackFn) {
      var id = _this.state.id;
      var elScreen = (0, _jquery["default"])(".".concat(id, ".as400-screen"));
    ...
    _this.getFieldHighlight = function () {
      return _this.state.markList[MARK_1.replace("-", "")];
    };

    _this.setFieldHighlight = function (highlight) {
      _this.markStringChackString(MARK_1, highlight);
    };

    _this.clearFieldHighlight = function () {
      return _this.clearMarkString(MARK_1);
    };

    _this.getLastSelection = function () {
...
function (_Emulator) {
  ...
  function ListMapping() {
    ...
    _this.getListHighlight = function () {
      var markType = MARK_1;
      return _this.state.markList[markType.replace("-", "")];
    };

    _this.setListHighlight = function (highlight) {
      _this.markStringChackString(MARK_1, highlight);
    };

    _this.clearListHighlight = function () {
      return _this.clearMarkString(MARK_1);
    };
...
function (_Emulator) {
  ...
  function ScreenMapping() {
    ...
    _this.getHighlight = function (markType) {
      return _this.state.markList[markType.replace("-", "")];
    };

    _this.setHighlight = function (markType, highlight) {
      _this.markStringChackString(markType, highlight);
    };

    _this.clearHighlight = function (markType) {
      return _this.clearMarkString(markType);
    };

    _this.getHighlightList = function () {
      return _this.state.markList;
    };

    _this.setHighlightList = function (highlightList) {
      _this.markAllCheckString(highlightList);
    };

    _this.clearHighlightList = function () {
